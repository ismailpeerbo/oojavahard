...
public class BuddyTester {
	public static void main( String[] args ) throws Exception {
		...
		int correct = 0;
		int total = 0;
		Scanner in = new Scanner(new File("../learn-oo-java-files/datafiles/buddytests.txt"));
		while ( in.hasNext() ) {
			...
			if ( got == wanted )
				...
				System.out.print( name2 + "-" + age1 + " should have given ");
				System.out.print( wanted + ", but got" + got + " instead." );
			}
		}
		in.close();
