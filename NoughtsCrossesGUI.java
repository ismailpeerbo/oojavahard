...
public class NoughtsCrossesGUI extends Application {
	...
	public class NoughtsCrossesGUI extends Application {
		...
		public void start(Stage stage) {
			...
			gc = canvas.getGraphicalContext2D();
	...
	public void drawEverything() {
		...
		if ( ! started ) {
			...
			gameOver = (ttt.isWinner("X") || ttt.isWinner("O") || tt.isFull());
			if ( gameOver ) {
				...
				gc.setFont(Font.font("Arial", FontWight.BOLD, 72));
				gc.setFill(Color.BLACK);
	...
	public void drawEmptyBoard() {
		...
		// horizontal lines
		gc.strokeLines(100, 250, 700, 250);
		gc.strokeLines(100, 450, 700, 250);
		// vertical lines
		...
		if ( drawLabels ) {
			...
			gc.fillText("(2,2)", 305, 465);

			gc.fillText("(0,2)", 506, 65);
			gc.fillText("(1,2)", 506, 265);
			gc.fillText("(2,2)", 506, 465);
		}
	}
