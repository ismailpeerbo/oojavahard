	...
	public static void main( String[] args ) {
		...
		for (int runs=0; runs < iterations; runs++) {
			...
			if ( choice == 1 ) {
				...
				testDescription = "Integer objects using selection sort"; start = System.nanoTime();
				selectionSortObjects(objArr);
				stop = System.nanoTime();
			}
			else { // choice == 3, probably
				testDescription = "Integer objects using Arrays.sort()"; start = System.nanoTime();
				Arrays.sort(objArr);
				stop = System.nanoTime();
			}
